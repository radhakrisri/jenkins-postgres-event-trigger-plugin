...
public class SupabaseEventTriggerTest {
    ...
    public void testTriggerCreation() {
        ...
        SupabaseEventTrigger trigger = new SupabaseEventTrigger(instanceName, tables);
    ...
    public void testTriggerDescriptor() throws Exception {
        ...
        SupabaseEventTrigger.DescriptorImpl descriptor = jenkins.jenkins.getDescriptorByType(SupabaseEventTrigger.DescriptorImpl.class);
        if (descriptor == null) {
            ...
            descriptor = new SupabaseEventTrigger.DescriptorImpl();
        }
        assertNotNull(descriptor);
        assertEquals("Supabase Event Trigger", descriptor.getDisplayName());
